...
def main():
    # Main title
    st.markdown("<h1 style='text-align: center; color: #4CAF50;'>PAN-Card Tampering Detection</h1>", unsafe_allow_html=True)
    st.markdown("<p style='text-align: center; color: #808080;'>Upload and compare two images to detect any modifications.</p>", unsafe_allow_html=True)
